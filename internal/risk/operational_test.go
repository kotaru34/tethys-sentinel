...
func TestOperationalRiskRules(t *testing.T) {
	tests := []struct {
		...
		{"ip route replace", []string{"ip", "route", "replace", "default", "via", "192.0.2.1"}, ApprovalRequired, "NETWORK_CONTROL"},
		...
		{"route add", []string{"route", "add", "default", "192.0.2.1"}, ApprovalRequired, "NETWORK_CONTROL"},
