...
var (
	...
	_ controlops.ApprovalLifecycle  = (*ApprovalLifecycle)(nil)
	_ controlops.ExecutionLifecycle = (*ExecutionLifecycle)(nil)
	_ controlops.JobAuthorizer      = (*JobAuthorizer)(nil)
