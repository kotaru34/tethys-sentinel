...
This document describes the `0.1.0-dev.22` candidate API surface with PostgreSQL schema v4. The previously accepted runtime baseline is `0.1.0-dev.20`. It is a development contract, not yet a stable public API.
