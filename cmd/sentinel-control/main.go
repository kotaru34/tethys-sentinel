...
func main() {
	...
	mcpClaimInternal := api.MCPClaimInternalHandler(persistence.mcpClaims)
	...
	internalMux.Handle("POST /internal/v1/mcp/claims/redeem", mcpClaimInternal)
	internalMux.Handle("POST /internal/v1/commands/submit", commandInternal)
	internalMux.Handle("POST /internal/v1/execution/jobs/get", agentJobs)
	internalMux.Handle("POST /internal/v1/execution/jobs/by-request", agentJobs)
	...
	mcpClaimAdmin := api.MCPClaimAdminHandler(persistence.mcpClaims)
	...
	adminMux.Handle("POST /admin/v1/mcp/claims", mcpClaimAdmin)
